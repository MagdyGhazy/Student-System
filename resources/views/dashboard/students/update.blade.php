<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('تعديــــل بيانـــــات الطــالب ') }}
        </h2>
    </x-slot>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        ...
                        <div class = "container">
                            <form action="{{route('student_update')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input id="phone" type="number" name="phone" class="form-control" value="{{$student->phone}}">
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input id="parent" type="text" name="parent" class="form-control" value="{{$student->parent->name}}">
                                    </div>

                                    <div class="col-md-6">
                                        <label for="p_phone">: {{ __('رقــم تليفـــون ولـــي الأمـــر') }}</label>
                                        <input id="p_phone" type="number" name="p_phone" class="form-control" value="{{$student->parent->phone}}">
                                    </div>
                                </div>
                                <br>
